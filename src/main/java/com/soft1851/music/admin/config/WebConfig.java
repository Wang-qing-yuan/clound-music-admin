...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtInterceptor).addPathPatterns("/**").excludePathPatterns("/sysAdmin/login","/captcha","/songList/list","/songList/page","/songList/type","/songList/select","/song/list","/song/select","/resources/songList","/resources/guide","/resources/model").excludePathPatterns("/static/**");
    }
}
